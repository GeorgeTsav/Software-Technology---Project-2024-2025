...
class MyProfile:
    def __init__(self, top=None, username=None):
        ...
        self.MyProfileframe.configure(relief='groove', borderwidth="2", background="#c0c0c0",
                                      highlightbackground=_bgcolor, highlightcolor=_fgcolor)
        ...
        self.MyProfilePhoto.configure(background="#8080ff", font="-family {Segoe UI} -size 9",
                                      foreground=_fgcolor, text='userphoto')
        ...
        self.MyReviews.configure(background="#808080",
                                 ...
                                 foreground=_fgcolor, text='My Reviews')
        ...
        self.MyMessages.place(relx=0.65, rely=0.611, height=28, width=146)
        self.MyMessages.configure(background="#808080",
                                  font="-family {Yu Gothic UI Semibold} -size 11 -weight bold -underline 1",
                                  foreground=_fgcolor, text='My Messages')
        ...
        self.Myreviewlist.configure(background="white", font="TkFixedFont", foreground=_fgcolor,
                                    highlightbackground=_bgcolor, highlightcolor=_fgcolor,
                                    selectbackground=_bgcolor, selectforeground="black")
