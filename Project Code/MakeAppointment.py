...
from ReservationScreen import ReservScreen
...
class MakeAppointmentScreen:
    def __init__(self, top=None, root=None, username="guest"):
        ...
        self.back_btn = tk.Button(self.btn_frame, text="Back", command=self.top.destroy)
    ...
    def SelectDate(self):
        ...
        ReservScreen(new_window, self.root, selected_date, self.username, previous_window=self.top)
