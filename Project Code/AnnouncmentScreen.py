...
from MakeAnnouncmentScreen import MakeAnnouncmentScreen
...
class AnnouncmentScreen:
    def __init__(self, top=None, ann_user="unknown"):
        ...
        self.Button1_1_1.configure(text='''Announcments''')
        ...
        self.Button1.configure(text='''Make an Announcment''')
        self.Button1.configure(command=self.open_make_announcment_screen)
        ...
        self.Button1_1.configure(text='''Announcments''')
    ...
    def open_make_announcment_screen(self):
        try:
            from MakeAnnouncmentScreen import MakeAnnouncmentScreen
        except ImportError:
            import tkinter.messagebox as msg
            msg.showerror("Error", "MakeAnnouncmentScreen module not found.")
            return
        top = tk.Toplevel(self.top)
        MakeAnnouncmentScreen(top, ann_user=self.ann_user)

def start_up():
    AnnouncmentScreen.AnnouncmentScreen.main()
