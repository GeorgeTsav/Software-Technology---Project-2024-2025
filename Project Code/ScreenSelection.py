...
from CancelationScreen import CancelationScreen
from MakeAppointmentScreen import MakeAppointmentScreen
...
class ScreenSelection:
    ...
    def goto_cancelation(self):
        ...
        CancelationScreen(new_top, self.root, self.username, self.app_id, previous_window=self.previous_window)
