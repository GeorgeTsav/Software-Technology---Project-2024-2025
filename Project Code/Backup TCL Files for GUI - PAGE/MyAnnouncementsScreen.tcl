...
#  May 23, 2025 10:07:43 AM EEST  platform: Windows NT
set vTcl(timestamp) ""
...
proc vTclWindow.top1 {base} {
    ...
    vTcl:DefineAlias "$top" "MyAnnouncementsScreen" vTcl:Toplevel:WidgetProc "" 1
    set vTcl(real_top) {}
    frame "$top.fra48" \
        -borderwidth 2 -relief groove -background #d9d9d9 -height 345 \
        -highlightbackground #d9d9d9 -highlightcolor #000000 -width 565 
    vTcl:DefineAlias "$top.fra48" "MyAnnouncementsFrame" vTcl:WidgetProc "MyAnnouncementsScreen" 1
    set site_3_0 $top.fra48
    canvas "$site_3_0.can47" \
        -background #ffffff -borderwidth 2 -closeenough 1.0 -height 323 \
        -highlightbackground #d9d9d9 -highlightcolor #000000 \
        -insertbackground #000000 -relief ridge -selectbackground #d9d9d9 \
        -selectforeground black -width 543 
    vTcl:DefineAlias "$site_3_0.can47" "MyAnnouncementsList" vTcl:WidgetProc "MyAnnouncementsScreen" 1
    place $site_3_0.can47 \
        -in $site_3_0 -x 0 -relx 0.018 -y 0 -rely 0.029 -width 0 \
        -relwidth 0.961 -height 0 -relheight 0.936 -anchor nw \
        -bordermode ignore 
    label "$top.lab49" \
        -activebackground #d9d9d9 -activeforeground black -anchor w \
        -background #ffffff -compound left -disabledforeground #a3a3a3 \
        -font "-family {Segoe UI} -size 22 -weight bold" -foreground #000000 \
        -highlightbackground #d9d9d9 -highlightcolor #000000 \
        -text "My Announcements" 
    vTcl:DefineAlias "$top.lab49" "MyAnnouncementsLabel" vTcl:WidgetProc "MyAnnouncementsScreen" 1
    ###################
    # SETTING GEOMETRY
    ###################
    place $top.fra48 \
    ...
    place $top.lab49 \
        -in $top -x 0 -relx 0.283 -y 0 -rely 0.044 -width 0 -relwidth 0.473 \
