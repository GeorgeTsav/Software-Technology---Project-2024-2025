...
import os.path
from AnnouncmentScreen import AnnouncmentScreen
...
class MainMenuScreen:
    def __init__(self, top=None, root=None, username=None):
        ...
        self.AnnouncementsButton.place(relx=0.271, rely=0.295, height=26, width=97)
        ...
        self.AnnouncementsButton.configure(command=self.open_announcements_screen)  # <-- προσθήκη
    ...
    def open_announcements_screen(self):
        new_top = tk.Toplevel(self.top)
        AnnouncmentScreen(new_top, ann_user=self.username)
